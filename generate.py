...
# encoder_decoder_config = EncoderDecoderConfig.from_pretrained('./models/checkpoint-1000')
# model = EncoderDecoderModel.from_pretrained('./models/checkpoint-1000', config=encoder_decoder_config)
...
print(type(model.encoder), type(model.decoder))
